...
@export var applied_shaders_dict: Dictionary[String, Resource] = {
    ICOSAHEDRON_SHADER_V_1 = ICOSAHEDRON_SHADER_V_1,
    CUTPLANE_EFFECT_V_2 = CUTPLANE_EFFECT_V_2,
    OUTLINE_V_1 = OUTLINE_V_1,
    EDGE_HIGHLIGHT_V_1 = EDGE_HIGHLIGHT_V_1,
}
@export var applied_shaders := applied_shaders_dict.values()
