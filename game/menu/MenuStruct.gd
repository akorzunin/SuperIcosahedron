    ...
    1: {
        ...
        items = {
            ...
            2: {
                ...
                options = {
                    1: { name = "on", value = true, action = "settings_invert_x" },
                    2: { name = "off", value = false, action = "settings_not_invert_x" },
                },
            },
        },
    },
    2: {
        ...
        items = {
            1: {
                ...
                options = {
                    1: { name = "on", value = true, action = "settings_fps_counter_on" },
                    2: { name = "off", value = false, action = "settings_fps_counter_off" },
                },
            },
            2: {
                name = "display\ndebug\nstats",
                ...
                options = {
                    1: { name = "on", value = true, action = "settings_display_debug_stats_on" },
                    2: { name = "off", value = false, action = "settings_display_debug_stats_off" },
                },
            },
        },
    },
    3: {
        ...
        items = {
            1: {
                ...
                options = {
                    1: { name = "fullscreen", value = true, action = "settings_fullscreen" },
                    2: { name = "bordered", value = false, action = "settings_bordered" },
                },
            },
            2: {
                name = "v-sync",
                ...
                options = {
                    1: { name = "on", value = true, action = "settings_vsync_on" },
                    2: { name = "off", value = false, action = "settings_vsync_off" },
                },
            },
            3: {
                name = "3d scale",
    ...
    4: {
        ...
        items = {
            1: {
                ...
                options = {
                    1: { name = "on", value = true, action = "settings_music_on" },
                    2: { name = "off", value = false, action = "settings_music_off" },
                },
            },
            2: {
                name = "sfx",
                setting = "SFX_ENABLED",
                options = {
                    1: { name = "on", value = true, action = "settings_sfx_on" },
                    2: { name = "off", value = false, action = "settings_sfx_off" },
                },
            },
        },
    },
...
static var menu_items := {
    name = "root",
    items = {
        1: { name = "start", action = "menu_level_select" },
        2: { name = "settings", items = settings_items },
        4: { name = "modifiers\nlibrary", action = "menu_modifier_library" },
        3: { name = "achivemets", action = "menu_show_achivemets" },
        5: { name = "exit", action = "menu_exit_game" },
        6: { name = "credits", action = "menu_show_credits" },
        7: { name = "???", action = "menu_easter_egg" },
    },
}
...
static var menu_items_emoji := {
    name = "root",
    items = {
        1: { 'name': "🎮", 'action': "menu_level_select" },
        2: { 'name': "⚙️", 'items': settings_items },
        4: { name = "📚", action = "menu_modifier_library" },
        3: { 'name': "🏆", 'action': "menu_show_achievements" },
        5: { 'name': "🚪", 'action': "menu_exit_game" },
        6: { 'name': "📜", 'action': "menu_show_credits" },
        7: { 'name': "o(`>w<')o", 'action': "menu_easter_egg" },
    },
}
